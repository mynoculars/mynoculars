"""
scripts/gc_memory.py -- launcher for research_agent.ops.gc_memory.

D-157: THE IMPLEMENTATION MOVED INTO THE PACKAGE. It used to live here,
in scripts/, which meant an installed wheel contained semantic-memory garbage collection
...
scripts/gc_memory.py` in README.md and OPERATIONS.md is still correct, and a
...
Equivalent, once the package is installed:
    research-agent-gc-memory --dry-run
"""
...
from research_agent.ops.gc_memory import main  # noqa: E402
