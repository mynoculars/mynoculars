"""
scripts/check_services.py -- launcher for research_agent.ops.check_services.

D-157: THE IMPLEMENTATION MOVED INTO THE PACKAGE. It used to live here,
in scripts/, which meant an installed wheel contained the live-service health check
...
scripts/check_services.py` in README.md and OPERATIONS.md is still correct, and a
...
from research_agent.ops.check_services import main  # noqa: E402
