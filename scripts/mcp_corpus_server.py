"""
scripts/mcp_corpus_server.py -- launcher for research_agent.servers.corpus.

D-157: THE IMPLEMENTATION MOVED INTO THE PACKAGE. It used to live here,
in scripts/, which meant an installed wheel contained the corpus MCP server (D-76: standalone Streamable HTTP)
...
scripts/mcp_corpus_server.py` in README.md and OPERATIONS.md is still correct, and a
...
Equivalent, once the package is installed:
    research-agent-mcp-corpus --port 8765
"""
...
from research_agent.servers.corpus import main  # noqa: E402
