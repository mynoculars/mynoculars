"""
scripts/inspect_memory.py -- launcher for research_agent.ops.inspect_memory.

D-157: THE IMPLEMENTATION MOVED INTO THE PACKAGE. It used to live here,
in scripts/, which meant an installed wheel contained read-only semantic-memory inspection (D-90)
...
scripts/inspect_memory.py` in README.md and OPERATIONS.md is still correct, and a
...
from research_agent.ops.inspect_memory import main  # noqa: E402
