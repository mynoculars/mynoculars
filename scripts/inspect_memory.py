...
# working directory -- same reasoning as every other script in this
# directory documents (a script launched from a shortcut, a scheduled
# task, or any other directory would otherwise fail with an opaque
# ModuleNotFoundError).
