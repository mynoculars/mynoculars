"""
scripts/ingest_sample_data.py -- launcher for research_agent.ops.ingest.

D-157: THE IMPLEMENTATION MOVED INTO THE PACKAGE. It used to live here,
in scripts/, which meant an installed wheel contained corpus ingest into both retrieval stores
...
scripts/ingest_sample_data.py` in README.md and OPERATIONS.md is still correct, and a
...
Equivalent, once the package is installed:
    research-agent-ingest --corpus <file.jsonl>
"""
...
from research_agent.ops.ingest import main  # noqa: E402
